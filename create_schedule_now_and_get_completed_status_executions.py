...
# Load from .env
host = os.getenv("host", "localhost") #save host in .env file ex: https://api.bolna.dev
api_key = os.getenv("api_key", None) #save api_key in .env file
agent_id = 'ee153a6c-19f8-4a61-989a-9146c31c7838' #agent_id in which we want to create the batch
file_path = '/Users/saurabhsingh/Downloads/bolna.csv' #path of the csv file
schedule_time = '2024-06-01T11:48:00Z' #enter the hardcoded schedule_time time
